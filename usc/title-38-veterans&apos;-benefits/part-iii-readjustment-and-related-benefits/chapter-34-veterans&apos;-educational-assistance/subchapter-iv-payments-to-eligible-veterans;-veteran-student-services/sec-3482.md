...
| Type of program | No dependents | One dependent | Two dependents | More than twodependents |
...
 
| Column I | Column II | Column III | Column IV | Column V |
| Basis | No dependents | One dependent | Two dependents | More than twodependents |
||||| The amount in column IV, plus the following for each dependent in excess of two: |
